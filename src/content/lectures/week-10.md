...
everyone present agrees, by unspoken consensus, to act as though the room is
silent. Taps are run to mask sound that both parties know isn't actually
masked. Conversations that would be casual anywhere else drop to nothing.
Nobody acknowledges any of it, and the whole system depends on nobody
acknowledging it.
